<template>
  <div class="grid grid-cols-3 gap-3 p-4">
    <button class="btn bg-blue-600" @click="home" :disabled="!canHome">
      🏠 Home
    </button>

    <button class="btn bg-yellow-600" @click="unlock" :disabled="!canUnlock">
      🔓 Unlock
    </button>

    <UButton icon="i-lucide-rocket" size="md" color="primary" variant="solid">Button</UButton>

    <button class="btn bg-red-600" @click="reset">🔄 Reset</button>
  </div>
</template>
...
const canUnlock = computed(() => machine.state === "Alarm");
